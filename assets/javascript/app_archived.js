...
let onStart = {
    ...
    loadAnswers: function() {
        ...
        let comboImagesSrc = combos[0].choices[0].url;
        console.log(comboImagesSrc);

        img.attr("src", comboImagesSrc);
        ...
        //     // console.log(figcaptions[i]);
        // }

        // console.log(combos[0].choices[0].url);
